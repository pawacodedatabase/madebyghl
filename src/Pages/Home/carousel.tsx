...
const slides = [
  {
    id: 1,
    title: "Own the Street with GHL",
    subtitle:
      "Step out in bold, premium-quality branded shirts that define urban edge and confidence.",
    buttonText: "SHOP NOW",
    image: banner1,
  },
  {
    ...
    subtitle:
      "Discover our statement shirts—crafted for those who lead, not follow.",
    buttonText: "SHOP NOW",
    image: banner2,
  },
  {
    ...
    subtitle:
      "From casual to bold, GHL shirts speak your style loud and clear.",
    buttonText: "SHOP NOW",
    image: banner3,
  },
  {
    ...
    subtitle:
      "Every GHL piece is a symbol of creativity, culture, and authenticity.",
    buttonText: "SHOP NOW",
    image: banner4,
  },
];
